#!/usr/bin/perl
#
# File: calculate_medians_from_a_tsv_table.pl by Marc Perry
# 
...
# median of all those values, and add the calculation as an additional
...
# 
#
# USAGE: ./$0 my_table.tsv > my_table_with_an_extra_column_of_median_values.tsv
# 
